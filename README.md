...
Figure 2: Real time capturing image from video
...
Sprint-1
Steps	Activity	Backlog
Analysis	●	Defined project requirements.	None
Design	●	None	None
Code	●	None	None
Test	●	None	None
Feedback	●	Make it a Software.
...
Steps	Activity	Backlog
Analysis	●	None	None
Design	●	Login, logout UI	None
Code	●	Developed Data Collection Code	None
Test	●	Performed test on Data Collection Code	None
Feedback	●	OK	None
...
●	Detailed UI mockups and user flows.	None
Code	●	Developed Preprocessing and Model Code
●	Performed Data Collection and Trained Model.	Correct Prediction rate was extremely low.
Test	●	Performed tests on Codes	None
Feedback	●	Instead of fixed frame for Hand, at first detect where Hand is.	None
...
Sprint-4
Steps	Activity	Backlog
Analysis	●	New Preprocessing Techniques	None
Design	●	None	None
Code	●	Developed Authentication System and Database.	None
Test	●	Performed tests on Authentication System	None
Feedback	●	OK	None
...
Design	
●	None	None
Code	●	Developed New Preprocessing Part.
●	Processed the Data Again and Trained the Model.
●	Integrate The Parts of Software.	None
Test	●	Evaluate the Software.	None
Feedback	●	OK	None
...
Analysis	●	None	None
Design	●	None	              None
Code	●	Added the Text to Voice Option
●	Added Hand detection from the whole Frame.	None
Test	●	Conducted end-to-end testing and fixes the Bugs.	None
Feedback	●	OK	None
